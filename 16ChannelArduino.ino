...
// Wi-Fi
const char* ssid = "WIFINAME";              // replace here to your wifi ssid
const char* password = "WIFIPASS";          // replace here to your wifi password

byte arduino_mac[] = { 0xDE, 0xED, 0xBA, 0xFE, 0xFE, 0xED };
IPAddress ip(192,168,1,4);                                    // setup here ip address for wifi relay module
IPAddress gateway(192,168,1,1);                                // check your WIFI router settings. it can be 192.168.0.1 or 192.168.1.1
